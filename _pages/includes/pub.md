...
- ``TWC`` [NOMA Empowered Integrated Sensing and Communication with Movable Antennas](https://ieeexplore.ieee.org/document/11298433), W Lyu, X Dong, R Yang, K Wang, Z Zhang, C Assi, C Yuen. 
- ``WCL`` [Flexible Cylindrical Array-Aided Secure Wireless Communications](https://arxiv.org/abs/2604.09128), X Dong, R Yang, S Yang, W Mei, L Zhu, Y Xiu, Z Zhang. 
